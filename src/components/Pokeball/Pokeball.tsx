import PokeballStyled from "./PokeballStyled";

export const PokeballIconSmall = ({ ...props }): React.ReactElement => {
  return (
    <PokeballStyled className="pokeball">
      <svg
        {...props}
        width="24"
        height="24"
